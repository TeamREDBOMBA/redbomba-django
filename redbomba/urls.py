...
urlpatterns = patterns('',
   ...
   url(r'^load/stream/$', 'redbomba.main.views.load_stream'),
   url(r'^load/post/$', 'redbomba.main.views.load_newsfeed'),
   url(r'^load/reply/$', 'redbomba.main.views.load_reply'),
   url(r'^load/post_profile/$', 'redbomba.main.views.load_post_profile'),
   url(r'^load/reply_profile/$', 'redbomba.main.views.load_reply_profile'),

   url(r'^main/new_post/$', 'redbomba.main.views.new_post'),
   url(r'^main/add_post_image/(?P<pid>\d+)$', 'redbomba.main.views.add_post_image'),
   url(r'^main/new_reply/$', 'redbomba.main.views.new_reply'),
   url(r'^main/new_smile/$', 'redbomba.main.views.new_smile'),
   url(r'^main/del_smile/$', 'redbomba.main.views.del_smile'),
   url(r'^main/follow/$', 'redbomba.main.views.follow'),
   url(r'^main/unfollow/$', 'redbomba.main.views.unfollow'),
